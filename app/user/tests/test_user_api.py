...
class PublicUserTests(TestCase):
    ...
    def test_create_user_success(self):
        ...
        # Now a user object is created, with data from recent create user
        user = get_user_model().objects.get(email=payload['email'])

        # Now it checks if password was correctly stored.
        self.assertTrue(user.check_password(payload['password']))

        # Now checks if the password was not returned with app response
    ...
    def test_password_too_short_error(self):
        """Test an error is returne if password is too short"""
        payload = {
            'email': 'test@example.com',
            'password': 'pw',
            'name': 'Test Name',
