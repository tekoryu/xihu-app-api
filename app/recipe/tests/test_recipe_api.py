...
class PrivateRecipeAPITests(APITestCase):
    ...
    def test_clear_recipe_tags(self):
        """Test clearing all existing tags."""
    ...
    def create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 25,
            'price': '2.55',
            'íngredients': [{'name': 'Lemon'}, {'name': 'Fish Sauce'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_clear_recipe_ingredients(self ):
        """Test clearing all existing ingredients."""
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Albergine with Tahini')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Posh Beans on Posh')
